...
extract_env() {
    ...
    local pattern="^(DOWNLOAD_.*|CIVITAI_TOKEN|HUGGINGFACE_API_KEY|USER_PASSWORD|.*_TO_DOWNLOAD|SSH_PUBLIC_KEY)$"
    local search_pattern="DOWNLOAD_.*|CIVITAI_TOKEN|HUGGINGFACE_API_KEY|USER_PASSWORD|.*_TO_DOWNLOAD|SSH_PUBLIC_KEY"
